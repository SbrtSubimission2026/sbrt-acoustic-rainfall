...
to perform data augmentation for Machine Learning pipelines.
...
class AugmenterConfig:
    ...
    @classmethod
    def from_kwargs(cls, **kwargs) -> 'AugmenterConfig':
        """
...
class AudioAugmenter:
    ...
    Parameters
    ----------
    config : AugmenterConfig, optional
    ...
    **kwargs : dict
    ...
    """
    def __init__(self, config: Optional[AugmenterConfig] = None, **kwargs):
        self.config = config if config is not None else AugmenterConfig.from_kwargs(**kwargs)
