...
preparing data for subsequent metric extraction and machine learning pipelines.
...
class SegmenterConfig:
    ...
    @classmethod
    def from_kwargs(cls, **kwargs) -> 'SegmenterConfig':
        """
...
class AudioSegmenter:
    ...
    Parameters
    ----------
    config : SegmenterConfig, optional
    ...
    **kwargs : dict
    ...
    """
    def __init__(self, config: Optional[SegmenterConfig] = None, **kwargs):
        self.config = config if config is not None else SegmenterConfig.from_kwargs(**kwargs)
